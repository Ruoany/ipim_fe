    ...
    <div class="form-container">
        ...
        <a-form class="form" :form="form" @submit="handleSubmit" v-bind="formatLayout">
            <div v-show="stepCurrent === 0">
                <a-form-item :label="$t('mfe.ab')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.ac')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.ad')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.ae')">
                    <a-input v-decorator />
                </a-form-item>
            </div>
            <div v-show="stepCurrent === 1">
                <a-form-item :label="$t('mfe.ag')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.ai')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.aj')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.ak')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.al')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.am')">
                    <a-input v-decorator />
                </a-form-item>
                <a-form-item :label="$t('mfe.an')">
                    <a-input v-decorator />
                </a-form-item>
            </div>
            <div v-show="stepCurrent === 2">
                <a-form-item :label="$t('mfe.ao')">
            ...
            <div v-show="stepCurrent === 3">
                ...
                <a-form-item :label="$t('mfe.cd')">
                    <upload />
                </a-form-item>
            </div>
            <div v-show="stepCurrent === 4">
                <a-form-item :label="$t('mfe.cg')">
                ...
                <a-form-item :label="$t('mfe.ch')">
                    <upload />
                </a-form-item>
                <a-form-item :label="$t('mfe.cj')">
                    <upload />
                </a-form-item>
            </div>
            <div v-show="stepCurrent === 5">
                <a-form-item :label="$t('mfe.ck')">
                    <ul>
                        <li>{{$t('mfe.cl')}}</li>
                        <li>{{$t('mfe.cm')}}</li>
                        <li>{{$t('mfe.cn')}}</li>
            ...
            <div v-show="stepCurrent === 6">
                ...
                <a-form-item :label="$t('mfe.da')">
                    <ul>
                        <li>{{$t('mfe.db')}}</li>
                    </ul>
                </a-form-item>
                <a-form-item :label="$t('mfe.dc')">
                    <ul>
                        <li>{{$t('mfe.dd')}}</li>
                        <li>{{$t('mfe.de')}}</li>
                        <li>{{$t('mfe.df')}}</li>
            ...
            <a-form-item>
                ...
                <a-button v-else type="primary" html-type="submit">{{ $t("mfe.dk") }}</a-button>
            </a-form-item>
        </a-form>
    </div>
</template>
