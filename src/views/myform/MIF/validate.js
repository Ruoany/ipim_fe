...
const exhibitionProducts = [
    ...
    { value: "TOY", label: "mif.dt" },
    { value: "GOVERNMENT_SERVICES", label: "mif.du" },
    { value: "MICE_BUSINESS_TRAVEL", label: "mif.dv" },
    { value: "FRANCHISE", label: "mif.dw" },
    { value: "DIGITAL_IMAGING", label: "mif.dx" },
