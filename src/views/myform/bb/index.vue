<template>
    <div class="form-container">
        ...
        <a-form-model ref="mission" class="form" :rules="rules" :model="form" @submit="handleSubmit" v-bind="formatLayout">
            ...
            <div v-show="stepCurrent === 4">
                <a-form-model-item :label="$t('formbb.bu')">
                    <a-button style="margin-left:20px" @click="downloadExcel('nameList')">{{ $t("formbb.bq") }}</a-button>
                    <a-button style="margin-left:20px" @click="downloadExcel('schedule')">{{ $t("formbb.br") }}</a-button>
                    <a-button style="margin-left:20px" @click="downloadExcel('budgetSheet')">{{ $t("formbb.bs") }}</a-button>
                </a-form-model-item>
                <a-form-model-item 
