<template>
    <a-form class="form" :form="form" @submit="handleSubmit">
        <div class="form-item-title">{{$t('formbf.ck')}}</div>
        <ul>
            <li>{{$t('formbf.aa')}}</li>
            <li>{{$t('formbf.ab')}}</li>
            <li>{{$t('formbf.ac')}}</li>
        </ul>
        <div class="form-item-title">{{$t('formbf.ad')}}</div>
        <a-form-item
            :label="$t('formbf.ae')"
        ...
        <div class="form-item-title">{{$t('formbf.an')}}</div>
        <a-form-item
            :label="$t('formbf.ao')"
            :label-col="formatLayout.labelCol"
            :wrapper-col="formatLayout.wrapperCol"
        ...
        <div class="form-item-title">{{$t('formbf.au')}}</div>
        <a-form-item
            :label="$t('formbf.av')"
            :label-col="formatLayout.labelCol"
            :wrapper-col="formatLayout.wrapperCol"
        ...
        <div class="form-item-title">{{$t('formbf.bf')}}</div>
        <a-form-item
            :label="$t('formbf.bg')"
            :label-col="formatLayout.labelCol"
            :wrapper-col="formatLayout.wrapperCol"
        ...
        <div class="form-item-title">{{$t('formbf.bi')}}</div>
        ...
        <div class="form-item-title">{{$t('formbf.bn')}}</div>
        <a-form-item
            :label="$t('formbf.bo')"
            :label-col="formatLayout.labelCol"
            :wrapper-col="formatLayout.wrapperCol"
        ...
        <a-form-item :label-col="specialLayout.labelCol" :wrapper-col="specialLayout.wrapperCol">
            <div class="form-item-title">{{$t('formbf.cf')}}</div>
            <a-radio-group v-decorator>
