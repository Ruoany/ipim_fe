<template>
    <div class="form-container">
        <a-steps :current="stepCurrent" direction="vertical" size="small">
            ...
            <a-step :title="$t('gmbpf.cf')" v-if="form.method === 'GROUP_EXHIBITION'" />
        </a-steps>
        <a-spin :spinning="loading" class="form">
            <a-form-model class="form" ref="gmbpf" :model="form" :rules="rules" v-bind="formatLayout">
                ...
                <div v-show="stepCurrent === 1">
                    ...
                    <a-form-model-item :label="$t('gmbpf.co')">
                        <ul>
                            <li>{{ $t("gmbpf.cp") }}</li>
                            <li>{{ $t("gmbpf.cq") }}</li>
                            <li>{{ $t("gmbpf.cr") }}</li>
                    ...
                    <a-form-model-item :label="$t('gmbpf.cs')">
                        <ul>
                            <li>{{ $t("gmbpf.ct") }}</li>
                            <li>{{ $t("gmbpf.cu") }}</li>
                            <li>{{ $t("gmbpf.cv") }}</li>
                    ...
                    <a-form-model-item :label="$t('gmbpf.da')">
                        <ul>
                            <li>{{ $t("gmbpf.db") }}</li>
                        </ul>
                    </a-form-model-item>
                ...
                <div v-show="stepCurrent === 2">
                    ...
                    <a-form-model-item :label="$t('gmbpf.ak')" required>
                        <a-input :value="selectedLiaison.fax" disabled />
                    </a-form-model-item>
                    <a-form-model-item :label="$t('gmbpf.al')" required>
                        <a-input :value="selectedLiaison.email" disabled />
                    </a-form-model-item>
                    <a-form-model-item :label="$t('gmbpf.am')" required>
...
import GMBPF from "@/apis/participateGmbpf";
export default {
