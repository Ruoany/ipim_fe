<template>
    <div class="all">
        <a-form-item :label="$t('reportbd.actualParticipation')">
...
<!-- 
        ...
        <a-form-item :label="$t('reportbd.af')">
            <a-input />
        </a-form-item>
        <a-form-item :label="$t('reportbd.ag')">
            <a-input />
            <a-textarea :placeholder="$t('reportbd.ew')" :autoSize="{ minRows: 4 }" />
        </a-form-item>
        <a-form-item :label="$t('reportbd.ah')">
            <a-radio-group name="radioGroup" :defaultValue="1">
                <a-radio :value="1">{{ $t("reportbd.di") }}</a-radio>
                <a-radio :value="2">{{ $t("reportbd.dj") }}</a-radio>
                <a-radio :value="3">{{ $t("reportbd.dl") }}</a-radio>
                <a-radio :value="4">{{ $t("util.other") }}({{ $t("reportbd.dm") }})</a-radio>
            </a-radio-group>
            <a-input :placeholder="$t('reportbd.dm')"></a-input>
        </a-form-item> -->
        <a-form-item :label="$t('reportbd.aj')">
            <div class="flex-justify-content-space-between">
        ...
        <a-form-item :label="$t('reportbd.ai')">
            <div class="flex-justify-content-space-between">
                <a-input style="width:24%;" :placeholder="$t('reportbd.ep')"></a-input>
                <a-input style="width:24%;" :placeholder="$t('reportbd.eq')"></a-input>
                <a-input style="width:24%;" :placeholder="$t('reportbd.er')"></a-input>
        ...
        <a-form-item :label="$t('reportbd.ak')">
            <div class="flex-justify-content-space-between">
                <a-input style="width:24%;" :placeholder="$t('reportbd.ep')"></a-input>
                <a-input style="width:24%;" :placeholder="$t('reportbd.eq')"></a-input>
                <a-input style="width:24%;" :placeholder="$t('reportbd.er')"></a-input>
        ...
        <!-- <a-form-item :label="$t('reportbd.al')">
            <a-input />
            <a-upload-dragger
                name="file"
                :multiple="true"
